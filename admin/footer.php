...
<script>
  const host = "http://localhost/arenalimanorte/controllers/";
  const hostOnlyJs = "http://localhost/arenalimanorte"
  <?php $hostOnly = "http://localhost/arenalimanorte" ?>
  const hostOnly = "<?= $hostOnly ?>";
  <?php $hostWithAppName = "http://localhost/arenalimanorte"?>
</script>
<!-- <script>
